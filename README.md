...
Several config options are available, as well as support for Generic Mod Config Menu.  These allow you to set your own chances for inheriting quality, enable cascading downgrades, and changing what happens when producing an item that would have quality in vanilla.
